    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-full mt-2 w-80 bg-black/60 backdrop-blur-xl rounded-xl shadow-2xl border border-white/10 z-40 overflow-hidden">
              ...
              {notifications.length === 0 ? (
                ...
                notifications.map(n => (
                  <div
                    ...
                    className={`px-4 py-3 cursor-pointer transition-colors hover:bg-white/5 ${!n.read ? 'bg-white/5' : ''}`}
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-1">
                          ...
                          {!n.read && <span className="w-2 h-2 rounded-full bg-indigo-500 flex-shrink-0 shadow-[0_0_8px_rgba(99,102,241,0.5)]" />}
                        </div>
