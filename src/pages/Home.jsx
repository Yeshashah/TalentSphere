...
export default function Home() {
  ...
  return (
    <div className="overflow-hidden bg-transparent relative selection:bg-indigo-500/30 text-white">
      {/* Decorative Background Elements */}
      <div className="absolute top-0 inset-x-0 h-screen bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-indigo-500/20 via-transparent to-transparent pointer-events-none" />
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-violet-600/10 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/3 pointer-events-none" />
      <div className="absolute top-[40%] left-0 w-[400px] h-[400px] bg-indigo-600/10 rounded-full blur-[120px] -translate-x-1/2 pointer-events-none" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 w-full z-10">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-indigo-300 text-sm font-semibold mb-10 shadow-sm ring-1 ring-white/5"
            >
              <Star className="w-4 h-4 text-amber-400 fill-amber-400" />
              <span className="tracking-wide uppercase text-xs">The ultimate talent ecosystem</span>
            </motion.div>

            <h1 className="text-6xl sm:text-8xl font-extrabold text-white leading-[1.1] tracking-tight mb-8">
              Where Talent <br className="hidden sm:block" />
              <span className="relative whitespace-nowrap">
                <span className="relative z-10 text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-violet-400 to-purple-400">Meets Opportunity</span>
                <svg className="absolute -bottom-2 left-0 w-full h-4 text-indigo-500/40 -z-10" viewBox="0 0 100 20" preserveAspectRatio="none">
                  <path d="M0,10 Q50,20 100,10" fill="currentColor" />
                </svg>
              </span>
            </h1>

            <p className="text-lg sm:text-2xl text-slate-300 max-w-2xl leading-relaxed mb-12 font-medium">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-5 w-full sm:w-auto">
              ...
              {(!user || user.role !== 'candidate') && (
                <Button
                  ...
                  size="lg"
                  disabled={loading}
                  className="w-full sm:w-auto gap-3 h-14 px-10 text-lg rounded-2xl bg-white/5 backdrop-blur-sm border-white/10 hover:bg-white/10 hover:border-white/20 text-white shadow-sm transition-all hover:-translate-y-1"
                >
      ...
      <section className="relative z-20 -mt-10 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <motion.div
            ...
            className="grid grid-cols-2 md:grid-cols-4 gap-6 p-8 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl shadow-black/50"
          >
            {stats.map((stat, i) => (
              <div key={stat.label} className="text-center p-4">
                <p className="text-4xl sm:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-white to-slate-400 mb-2">
                  {stat.value}
                </p>
      ...
      <section className="py-24 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-20">
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-6 tracking-tight">Engineered for excellence</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((f, i) => (
              <motion.div
                ...
                className="group relative bg-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/10 shadow-lg shadow-black/20 hover:shadow-2xl hover:shadow-indigo-500/20 hover:bg-white/10 transition-all duration-500"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl -z-10" />
                <div className="w-14 h-14 rounded-2xl bg-indigo-500/20 text-indigo-300 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-indigo-500 group-hover:text-white transition-all duration-500">
      ...
      <footer className="py-12 border-t border-white/10 bg-black/40 backdrop-blur-md relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-xl font-bold text-white tracking-tight">TalentSphere<span className="text-indigo-400">.</span></div>
          <p className="text-sm font-medium text-slate-500">© 2026 TalentSphere Inc. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
